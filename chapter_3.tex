...
\begin{figure}
	...
	\caption{Evaluation signals, fully synthetic left and simulated on right.}
	\label{fig:synKicks}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{./chapter_3_figures/basicConvergance.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=1\linewidth]{./chapter_3_figures/paddedConvergance.pdf}
...
\begin{figure}
	...
	\caption{Statistical variance of tune evaluation methods vs window length for different noise seeds with identical magnitude.}
	\label{fig:noiseConv}
\end{figure}
...
\begin{figure}
	...
	\caption{Variation of tune measurements with initial phase for synthetic signal.}
	\label{fig:baseRoll}
\end{figure}
...
\begin{figure}
	...
	\caption{Example kick for tune evaluation, TBT BPM B1R signal.}
...
\begin{figure}
	...
	\caption{PCA decomposition of TBT signals for kick.}
	\label{fig:pcaComps}
\end{figure}
...
\begin{figure}
	...
	\caption{First four PCA temporal modes from decomposition in figure \ref{fig:pcaComps}.}
	\label{fig:pcaTemps}
\end{figure}
...
\begin{figure}
	...
	\caption{Example resonant capture kick, TBT BPM B1R signal.}
...
\begin{figure}
	...
	\caption{Resonant capture spectrogram of TBT signal from figure \ref{fig:resCapReal}.}
...
\begin{figure}
    ...
    \caption{Goodness of Fit to raw BPM signals and signals with linear calibration factors applied.}
    \label{fig:rawVcal}
\end{figure}
...
\begin{figure}
    ...
    \caption{Goodness of fit to raw BPM signals and signals with calibrations and dropping unreliable BPM A1C.}
    \label{fig:rawVA1C}
\end{figure}
...
\begin{figure}
    ...
    \caption{Goodness of fit to signals with calibrations and dropped A1C versus PCA ``cleaning".}
    \label{fig:calVpca}
\end{figure}
...
\begin{figure}
    ...
    \caption{Goodness of fit for signals with nominal preprocessing versus signals with nominal preprocessing and dropped BPM B2L.}
    \label{fig:prepVB2L}
\end{figure}
...
To evaluate the lifetime from camera images, the relative intensity (simply the sum of the full image) and time stamps of the image could be fit with an exponential decay, eq. \ref{eq:expLife}. The uncertainty of the lifetime was determined from the uncertainty in the fit. Experimental results for lifetime measurements are described in section \ref{sec:intCross}.
\begin{equation}
	I(t) = I_o e^{-\frac{t}{\tau}}
	\label{eq:expLife}
\end{equation}
