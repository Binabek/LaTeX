...
\begin{figure}
	...
	\caption{Sychrotron radiation profiles for the nominal lattice on the left, and lattice optimized for lifetime on the right, in camera M3R, t-parameter $t=-0.525$}
