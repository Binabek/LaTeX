...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{./appendix_figures/active-area-3-axis-probe.png}
	\caption{Manufacurer's diagram of hall effect sensor placement in probe \cite{FPSeriesHall}.}
...
\begin{figure}
	\centering
	\includegraphics[width=0.6\linewidth]{./appendix_figures/uncompMults.pdf}
	\caption{Multipole decomposition for octupole magnets based on azimuthal field calculated from measured horizontal and vertical fields.}
	\label{fig:hallProbe}
\end{figure}
