...
\begin{table}
    ...
    Radiation Damping Times\footnotemark[1] $x,y,s$ & 2.8, 0.65, 0.24 [s]\\
    Equalibrium Emittances\footnotemark[1] $x,y$ & \num{1.67e-7},0 [m-rad]\\
    \bottomrule
    \end{tabular}
...
\footnotetext[1]{Calculated from linear radiation integrals \cite[pg.438]{leeAcceleratorPhysics2018} without quantum excitation}
