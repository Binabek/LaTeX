...
\begin{multline} \label{eq:H_p}
	H_p = \frac{H_s}{p_o} = -\left(1 + \frac{x}{\rho}\right)\sqrt{\left(\frac{\tilde{E}_{\Phi} - \frac{q}{p_o}\Phi}{c}\right)^2 - \left(p_x -\frac{q}{p_o} A_x\right)^2 - \left(p_y - \frac{q}{p_o} A_y\right)^2 - \frac{m^2c^2}{p_o^2}}\\ - \left(1 + \frac{x}{\rho}\right)\frac{q}{p_o}A_s
\end{multline}
...
The next transformation is for the 
