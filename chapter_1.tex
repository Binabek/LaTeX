...
\begin{figure} 	\centering
	...
	\caption{Poincar\'{e} section ellipse of linear betatron motion with associated relationships to Courant-Snyder parameters \cite{hueblNextGenerationComputational2022}}
	\label{fig:csEllipse}
\end{figure}
