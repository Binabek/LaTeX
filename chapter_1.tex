...
For a quadrupole of a given lenth $L$, we can define a matrix which represents the three linear solutions for our different dimensions if it acts on a state vector of our canonical coordinates.

\begin{equation} \label{mat:quad}
\begin{pmatrix} 
