...
\begin{figure} 
	\centering
	\includegraphics[width=0.8\linewidth]{./chapter_1_figures/madxFrenetSerret.pdf}
...
\begin{figure} 	\centering
	\includegraphics[width=\linewidth]{./chapter_1_figures/phase_space_ellipseImpactX.pdf}
	\caption{Poincar\'{e} section ellipse of linear betatron motion with associated relationships to Courant-Snyder parameters. Here $q$ refers to a generic transverse coordinate, $x$ or $y$ in the current derivation. \cite{hueblNextGenerationComputational2022}}
	\label{fig:csEllipse}
\end{figure}
...
\begin{figure} 
	\centering
	\includegraphics[width=0.8\linewidth]{./chapter_1_figures/iucfSextupole.png}
